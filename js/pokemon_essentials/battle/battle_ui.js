        ...
        (function (UI) {
            ...
            var CommandButton = /** @class */ (function (_super) {
                ...
                function CommandButton(name, frame, x, y) {
                    ...
                    _this.y = y;
                    _this._active = false;
                    _this.bitmap = ImageManager.loadBitmap('img/pictures/Battle/', 'battle_buttons', undefined, undefined);
                    _this.changeFrame(1, _this.frame);
            ...
            var MoveButton = /** @class */ (function (_super) {
                ...
                function MoveButton(move, x, y) {
                    ...
                    _this.bitmap = ImageManager.loadBitmap('img/pictures/Battle/', 'moves_buttons', undefined, undefined);
            ...
            var BattleCommands = /** @class */ (function (_super) {
                ...
                function BattleCommands(x, y) {
                    ...
                    _this.options = [
                        ...
                        { name: 'PARTY', frame: 1, x: startX + 84, y: startY, action: _this.openParty },
                        { name: 'BAG', frame: 2, x: startX, y: startY + 32, action: _this.openBag },
                        { name: 'RUN', frame: 3, x: startX + 84, y: startY + 32, action: _this.run }
                    ];
                    _this.createBackground();
                    _this.createButtons();
                    return _this;
                ...
                BattleCommands.prototype.createButtons = function () {
                    ...
                    this.options[UI.actionsInx].sprite.active = true;
                };
                BattleCommands.prototype.updateInput = function () {
                    ...
                    if (Input.isTriggered('right')) {
                        this.options[UI.actionsInx].sprite.active = false;
                        UI.actionsInx++;
